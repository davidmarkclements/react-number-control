...
var NumberSpinner = (function (_Component) {
  _inherits(NumberSpinner, _Component);

  function NumberSpinner(_ref) {
    ...
    _get(Object.getPrototypeOf(NumberSpinner.prototype), 'constructor', this).call(this);
    this.state = {
      max: 4,
      min: 0,
      n: 0
